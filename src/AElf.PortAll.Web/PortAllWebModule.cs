...
namespace AElf.PortAll.Web
{
    [DependsOn(
        ...
        typeof(PortAllHttpApiClientModule),
        ...
        public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
            {
                options.AddAssemblyResource(
                    typeof(PortAllResource),
                    typeof(PortAllDomainSharedModule).Assembly,
                    typeof(PortAllApplicationContractsModule).Assembly,
                    typeof(PortAllWebModule).Assembly
                );
            });
        }
